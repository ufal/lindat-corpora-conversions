#!/usr/bin/python2.7
#The script handles the problem of fused tokens transforming the CoNLLU format
#so that the search in KonText can be done for the whole word as well. It is a modified version of:
